...
class MessageBox(object):
    ...
    def __init__(self, title, msg, b1, b2, frame, t, entry):
...
def mbox(title, msg, b1='OK', b2='Cancel', frame=True, t=False, entry=False):
    ...
    """
    msgbox = MessageBox(title, msg, b1, b2, frame, t, entry)
